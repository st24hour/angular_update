...
for i in 6250
do
	CUDA_VISIBLE_DEVICES=6 python direction.0.0.5.py \
					--dataset cifar10 \
					--num_workers 2 \
					--num_sample $i \
					--epochs 300 \
...
# do
# 	CUDA_VISIBLE_DEVICES=6 python direction.0.0.3.py \
# 					--dataset cifar10 \
# 					--num_workers 2 \
# 					--num_sample $i \
# 					--epochs 300 \
...
# for i in 0 25000 12500 6250 3125
# do
# 	CUDA_VISIBLE_DEVICES=6 python direction.0.0.4.py \
# 					--dataset cifar10 \
# 					--num_workers 2 \
# 					--num_sample $i \
# 					--epochs 600 \
...
############################## 220302 ###########################
# GCP
# for i in 25000 12500 6250 3125
# do
# 	CUDA_VISIBLE_DEVICES=6 python direction.0.0.3.py \
# 					--dataset cifar10 \
# 					--num_workers 2 \
