...
# IITP, samsung
# nvidia-docker run --shm-size=128G --cpus=16 -it --rm -v $(pwd):$(pwd) \
...
# nvidia-docker run --shm-size=1024M --cpus=8 -it --rm -v $(pwd):$(pwd) -v /home/siit/jusung/:/home/user/jusung/ -w $(pwd) \
# 	st24hour/pytorch:1.6.0_large_batch_v2 \
# 	sh train1.sh
