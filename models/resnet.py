...
# This module is used in resnet18_invariant
...
class ResNet_GBN_bn_fix(nn.Module):
    def __init__(self, block, num_blocks, std_weight=1., num_classes=10, zero_init_residual=False, amp=True, eps=1e-05):
        super(ResNet_GBN_bn_fix, self).__init__()
        self.amp = amp
        self.eps = eps
        self.in_planes = 64
...
def resnet18_GBN_bn_fix(num_classes, std_weight=1., zero_init_residual=False, amp=True, eps=1e-05):
    return ResNet_GBN_bn_fix(BasicBlock_GBN_bn_fix, [2,2,2,2], std_weight=std_weight, num_classes=num_classes, \
                                zero_init_residual=zero_init_residual, amp=amp, eps=eps)
