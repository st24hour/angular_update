...
do
	CUDA_VISIBLE_DEVICES=4 python direction.0.0.5.py \
					--dataset cifar10 \
					--num_workers 2 \
					--num_sample $i \
					--epochs 300 \
...
# do
# 	CUDA_VISIBLE_DEVICES=4 python direction.0.0.3.py \
# 					--dataset cifar10 \
# 					--num_workers 2 \
# 					--num_sample $i \
# 					--epochs 300 \
...
# for i in 0 25000 12500 6250 3125
# do
# 	CUDA_VISIBLE_DEVICES=4 python direction.0.0.4.py \
# 					--dataset cifar10 \
# 					--num_workers 2 \
# 					--num_sample $i \
# 					--epochs 600 \
...
# for i in 0
# do
# 	CUDA_VISIBLE_DEVICES=8,9 python direction.0.0.2.py \
# 					--GCP \
# 					--dataset imagenet \
# 					--num_workers 12 \
# 					--num_sample $i \
