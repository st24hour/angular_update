...
def getSTL10(batch_size, data_root='/tmp/public_dataset/pytorch', train=True, val=True, **kwargs):
    ...
    ds = []
    if train:
        dataset = datasets.STL10(root=data_root, split='train', download=True, transform=transform_train)
...
def getTINYIMAGENET(batch_size, data_root='/home/user/ssd1/data/tiny-imagenet-200/', train=True, val=True, **kwargs):
    ds = []
...
def getDataSet(data_type, batch_size, dataroot, **kwargs):
    ...
    # old... do not use
        ...
        train_loader, test_loader = getTINYIMAGENET(batch_size=batch_size, data_root=dataroot, **kwargs)  

    elif data_type == 'stl10':
        train_loader, test_loader = getSTL10(batch_size=batch_size, data_root=dataroot, **kwargs)
